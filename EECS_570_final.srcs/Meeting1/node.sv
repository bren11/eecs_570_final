...
module NODE ( input                     clk,
              ...
              input                     router_ack,
              input ACTIVATION_VALUE    weight_in,
    ...
    ACTIVATION_VALUE input_weight;
    ACTIVATION_VALUE input_weight_n;
    ...
    assign current_value = router_ack ? 0 : output_register;
    ...
    always_comb begin
        ...
        if (bus_in.valid & cfg.connection_mask[bus_in.neuron_num]) begin
            /////////////// receive input ///////////////
            input_reg_n = bus;
            input_weight_n = weight_in;
        end


        /////////////// get weight and activation at the head of the buffer ///////////////

        if ((~done & input_reg.valid) | router_ack) begin
            /////////////// operate ///////////////
            case (cfg.op_type)

                MACC: begin
                    partial_output = input_weight * input_reg;
